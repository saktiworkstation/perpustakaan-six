        ...
        <div class="row">
            <div class="col-8 main-content">
                <div class="row">
                    <div class="col-4">
                        <figure class="figure">
                            <img src="assets/img/card/oob.png" class="figure-img img-fluid rounded" alt="...">
                        </figure>
                    </div>
                    <div class="col-8">
                        <h1 class="text-head">Orang-orang Biasa</h1>
                ...
                <div class="row row-sinopsis">
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Laudantium reprehenderit pariatur nemo nam.
                        Atque, cum facilis! Quos et reprehenderit nesciunt qui consectetur cumque dolorum, veritatis maiores
                        quisquam.
                        Aliquid, veniam tempore dolorem commodi optio iusto blanditiis possimus porro vero nobis ea culpa
                        voluptate natus
                        consequatur reprehenderit laboriosam atque aliquam modi eligendi laborum numquam necessitatibus?
                        Aliquam veniam magni dolore
                        magnam totam aliquid explicabo eligendi voluptas ratione quibusdam quo laboriosam, fuga dignissimos
                        veritatis a inventore rem consectetur id.
                        Iste, ab voluptatem maiores iure reprehenderit, consectetur ipsa quae deleniti nulla placeat, atque
                        nesciunt vitae. Harum dolore facere numquam?
                        Quos vero labore nobis modi quia.</p>
                </div>
